...
export default function ProductDetailDescription({
  ...
  return (
    <div className="max-w-[1110px] w-[100vw] mt-[25px] mx-auto relative px-[12px]">
      <div className="w-[45px] text-white flex justify-center items-center h-[45px] border bg-primary-green bottom-[-21px] absolute rounded-[50%] left-[50%] translate-x-[-50%] opacity-[80%] mp"
      ...
      <div className="">
        <div
          className={clsx('mt-[16px] border p-[12px] bg-white text-[14px] rounded-[3px] border-white duration-[350ms] overflow-scroll',{
